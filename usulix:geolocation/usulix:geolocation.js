...
Geolocation = {
    ...
    /**
     * @summary Get the current status of position watching
     * @return boolean watchingPosition
     */
    status: function () {
        return watchingPosition;
    },

    /**
     * @summary Set the maximumAge value to allow some cache of position
     * @return boolean watchingPosition
     */
    setMaximumAge: function (intMilliseconds) {
        if(options.maximumAge == intMilliseconds){
            return;
        }
        watchingPosition = false;
        options.maximumAge = intMilliseconds;
        startWatchingPosition();
    }
